...
public class ArduinoCommunicator implements SerialPortEventListener {
	...
	public synchronized void close() {
		System.out.println("LOGGING:       CLOSING ARDUINO COMMUNICATOR");
		if (serialPort != null) {
	...
	public synchronized void serialEvent(SerialPortEvent oEvent) {
		System.out.println("LOGGING:       READING FROM ARDUINO");
		if (oEvent.getEventType() == SerialPortEvent.DATA_AVAILABLE) {
			try {
				...
				if(new String(chunk).equals("G")) {
					System.out.println("LOGGING:       ARUINO READY FOR COMMUNICATION");
					ready = true;
				}
			} catch (Exception e) {
